function [street_inwards_next, ...
    ...
    trace_left_next, trace_left_speed_next, trace_right_direction_next, trafficlight] ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%CROSSLIGHT Calculation of update for a certain crossroad, including lane for cars turning left
%and 8 cells of street_inwards and street_outwards
%
%additional Output:
%inwards_gaps: gap to place car from street_inwards when entering the 8 cells in front of
%crossroad calculated by crosslight
%trafficlight: signalisation for every lane to plot traffic lights in
%display
%
%additional INPUT:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%set traffic light
%trafficlight = zeros(12,1) 0=red for car and pedestrians
trafficlight = settrafficlight(localphase, aheadphase, turnphase, pedestrian_density);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%place randomly pedestrians
for k = 1:4
    if (rand(1) <= pedestrian_density )
        pedestrian_bucket(2,k) = 1;     %use bucket to make sure that pedestrians accumulate during redphase
    end
